...
def batch_generator( data, batch_size, max_c_length, max_q_length ):
    '''
  This function:
  ...
  '''
    ...
    context, length_context = pad_results(context, max_c_length)

    question, length_question = pad_results(question, max_q_length)
...
def qualitative_inspection( context, context_lengths, question, question_lengths, answer, result, id2word,
                            max_evaluations=50 ):
